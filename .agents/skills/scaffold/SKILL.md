...
2. `AGENTS.md` — load architecture rules, naming conventions, and constraints
...
**ALWAYS:**
- Read `SPEC.md`, `AGENTS.md`, and `TASKS.md` before writing a single line of code
...
- Violate the architecture rules in `AGENTS.md`
