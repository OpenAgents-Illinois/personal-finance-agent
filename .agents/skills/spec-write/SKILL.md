...
skip_for: implementation tasks (use tasks-write), Codex instructions (use claudemd-setup)
---
...
Produce a `SPEC.md` that serves as the single source of truth for what a project is, what it does, and how it is built. This document drives `TASKS.md`, `AGENTS.md`, and all implementation decisions.
